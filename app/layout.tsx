...
export const metadata = {
  title: "Johnny | Portfólio",
  description:
    "This is Johnny's portfolio website, im a web fullstack developer.",
};
          ...
          <Toaster
            ...
            toastOptions={{
              success: {
                style: {
                  background: "green",
                  color: "white", // Added white text for success
                },
                icon: "✔️", // Added checkmark icon for success
              },
              error: {
                style: {
                  background: "red",
                  color: "white", // Added white text for error
                },
                icon: "❌", // Added cross icon for error
              },
            }}
          />
          </ActiveSectionContextProvider>
